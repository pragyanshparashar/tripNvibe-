...
export default function CtaSection() {
  return (
    <section className="px-6 py-16">
      <div className="glass-dark relative mx-auto max-w-4xl overflow-hidden bg-brand px-8 py-16 text-center shadow-lift">
        <h2 className="font-display text-3xl font-bold text-cream-50 sm:text-4xl">
          Ready to find your group&rsquo;s vibe?
        </h2>
        <p className="mx-auto mt-4 max-w-md font-body text-navy-50">
