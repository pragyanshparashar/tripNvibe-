...
export default function PaymentPage() {
  ...
  if (status === 'success') {
    return (
      <div className="mx-auto flex min-h-[70vh] max-w-md flex-col items-center justify-center px-6 text-center">
        <div className="flex h-24 w-24 animate-fadeUp items-center justify-center rounded-full bg-sunset text-5xl text-white shadow-lift">
          ✓
        </div>
        <h1 className="mt-6 font-display text-3xl font-bold text-deep-900">Payment Successful</h1>
        ...
        <p className="mt-6 font-body text-xs text-deep-300">
  ...
  return (
    <div className="mx-auto flex min-h-[70vh] max-w-md flex-col items-center justify-center px-6 text-center">
      ...
      <h1 className="mt-2 font-display text-5xl font-bold text-deep-900">{formatCurrency(contribution)}</h1>
      <p className="mt-3 font-body text-deep-500">
        for {room.destination} &middot; split {participantCount} ways
      </p>

      <div className="mt-10 w-full rounded-3xl bg-white p-6 shadow-soft">
        <div className="flex items-center justify-between font-body text-sm text-deep-600">
          <span>Payment method</span>
          <span className="font-semibold text-deep-900">UPI / Card</span>
        </div>
      </div>
